/*!
 Stencil Testing v4.45.1 | MIT Licensed | https://stenciljs.com
 */
"use strict";
...
${e}`);
  ...
  if (config.testing.browserWSEndpoint) {
    ...
    try {
      launchOpts.executablePath = process.env.PUPPETEER_EXECUTABLE_PATH || process.env.CHROME_PATH || await puppeteer.executablePath(launchOpts);
    } catch (_) {
...
function jestSetupTestFramework() {
  ...
  beforeEach(() => {
    ...
    import_testing.modeResolver.length = 0;
  });
  afterEach(async () => {
...
function jestSetupTestFramework2() {
  ...
  beforeEach(() => {
    ...
    import_testing2.modeResolver.length = 0;
  });
  afterEach(async () => {
    var _a2, _b, _c, _d, _e, _f;
...
function jestSetupTestFramework3() {
  ...
  beforeEach(() => {
    ...
    import_testing3.modeResolver.length = 0;
  });
  afterEach(async () => {
    var _a2, _b, _c, _d, _e, _f;
