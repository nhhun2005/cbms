/*!
 Stencil Mock Doc (CommonJS) v4.45.1 | MIT Licensed | https://stenciljs.com
 */
"use strict";
...
function resetWindow(win) {
  if (win != null) {
    ...
    win.fetch = windowDestroyed;
    win.Headers = windowDestroyed;
    win.Request = windowDestroyed;
    win.Response = windowDestroyed;
    win.FetchError = windowDestroyed;
  }
}
