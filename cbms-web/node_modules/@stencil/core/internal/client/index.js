/*
 Stencil Client Platform v4.45.1 | MIT Licensed | https://stenciljs.com
 */
...
var insertBefore = (parent, newNode, reference, isInitialLoad) => {
  ...
  if (BUILD20.slotRelocation && (parent == null ? void 0 : parent.__insertBefore)) {
    ...
    if (BUILD23.observeAttribute && (!BUILD23.lazyLoad || flags & 1 /* isElementConstructor */)) {
      ...
      prototype.attributeChangedCallback = function(attrName, oldValue, newValue) {
        plt.jmp(() => {
          ...
          if (BUILD23.reflect && propMemberFlags & 512 /* ReflectAttr */ && propMemberFlags & 8 /* Any */ && // a complex value is never written to an attribute, so a change while the prop holds
          ...
          const currentValue = BUILD23.lazyLoad && propMemberFlags & 4096 /* Setter */ ? hostRef.$instanceValues$.get(propName) : this[propName];
...
var proxyCustomElement = (Cstr, compactMeta) => {
  if (BUILD27.profile && performance.mark && performance.getEntriesByName("st:app:start", "mark").length === 0) {
