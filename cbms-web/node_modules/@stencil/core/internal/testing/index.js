...
var insertBefore = (parent, newNode, reference, isInitialLoad) => {
  ...
  if (import_app_data13.BUILD.slotRelocation && (parent == null ? void 0 : parent.__insertBefore)) {
    ...
    if (import_app_data16.BUILD.observeAttribute && (!import_app_data16.BUILD.lazyLoad || flags & 1 /* isElementConstructor */)) {
      ...
      prototype.attributeChangedCallback = function(attrName, oldValue, newValue) {
        plt.jmp(() => {
          ...
          if (import_app_data16.BUILD.reflect && propMemberFlags & 512 /* ReflectAttr */ && propMemberFlags & 8 /* Any */ && // a complex value is never written to an attribute, so a change while the prop holds
          ...
          const currentValue = import_app_data16.BUILD.lazyLoad && propMemberFlags & 4096 /* Setter */ ? hostRef.$instanceValues$.get(propName) : this[propName];
...
var proxyCustomElement = (Cstr, compactMeta) => {
  if (import_app_data20.BUILD.profile && performance.mark && performance.getEntriesByName("st:app:start", "mark").length === 0) {
