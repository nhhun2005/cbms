        ...
        if (!(cmpMeta.$flags$ & 1 /* shadowDomEncapsulation */)) {
          if (styleContainerNode.nodeName === "HEAD") {
            ...
            if (supportsConstructableStylesheets) {
              ...
              if (existingStyleContainer && !BUILD6.hotModuleReplacement) {
...
// src/runtime/mode.ts
var computeMode = (elm) => modeResolver.map((h2) => h2(elm)).find((m) => !!m);
var setMode = (handler) => {
...
var insertBefore = (parent, newNode, reference, isInitialLoad) => {
  ...
  if (BUILD14.slotRelocation && (parent == null ? void 0 : parent.__insertBefore)) {
    ...
    if (BUILD17.observeAttribute && (!BUILD17.lazyLoad || flags & 1 /* isElementConstructor */)) {
      ...
      prototype.attributeChangedCallback = function(attrName, oldValue, newValue) {
        plt.jmp(() => {
          ...
          if (BUILD17.reflect && propMemberFlags & 512 /* ReflectAttr */ && propMemberFlags & 8 /* Any */ && // a complex value is never written to an attribute, so a change while the prop holds
          ...
          const currentValue = BUILD17.lazyLoad && propMemberFlags & 4096 /* Setter */ ? hostRef.$instanceValues$.get(propName) : this[propName];
          const propDesc = Object.getOwnPropertyDescriptor(prototype, propName);
          if (!isSpuriousBooleanRemoval && newValue != currentValue && (!propDesc.get || !!propDesc.set)) {
            this[propName] = newValue;
          }
        });
      };
...
var proxyCustomElement = (Cstr, compactMeta) => {
  if (BUILD21.profile && performance.mark && performance.getEntriesByName("st:app:start", "mark").length === 0) {
